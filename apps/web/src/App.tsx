...
function ChannelIntegration({ user, onError }: { user: PanelUser; onError: (message: string) => void }) {
  ...
  return <section className="channel-integration">
    ...
    <div className="channel-body">
      ...
      {selectedChannel ? <>{selectedChannel.connection_status === 'active' && <ChatAiConnectionTest phone={connectionTestPhone} onPhoneChange={setConnectionTestPhone} busy={testingConnection} result={connectionTestResult} onSubmit={testConnection} />}
